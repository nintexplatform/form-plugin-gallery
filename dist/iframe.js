...
let NintexGalleryIframe = _decorate([e$2('nintex-gallery-iframe')], function (_initialize, _LitElement) {
  class NintexGalleryIframe extends _LitElement {
    constructor() {
      super(...arguments);
      _initialize(this);
    }
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        if (!this.src) {
          return y`<span>No source url defined</span>`;
        }
        const frameStyles = {
